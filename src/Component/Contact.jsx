      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ...
            clinic to schedule an appointment, ask about our services, or speak
            directly with our care specialists.
          </p>
        </header>

        <main className="flex flex-col mt-7 lg:flex-row gap-12">
